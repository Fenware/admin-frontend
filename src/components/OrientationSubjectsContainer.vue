      ...
      <div
        ...
        :class="
          subjectIsSelected(parseInt(subject.id))
            ? ' bg-blue-700 bg-opacity-50 block m-2 px-5 py-1 hover:bg-opacity-20 backdrop-filter backdrop-blur-xl shadow-2xl rounded-full cursor-pointer transform-gpu transition-all duration-200'
