<template>
  ...
  >
    ...
    >
      ...
      <div>
        <i
          ...
          id="reload"
          class="fas fa-sync-alt cursor-pointer animate-none"
        ></i>
      </div>
    </div>

    <div
      v-for="user in users_pending"
      :key="user.id"
      class="flex justify-evenly text-lg mt-4 mb-2 mx-5 py-4 px-3 bg-white bg-opacity-10 backdrop-filter backdrop-blur-xl shadow-2xl rounded-2xl"
    >
      ...
      <div class="text-center">
        ...
        >
          <i class="fas fa-times text-red-300 mx-1 text-md drop-shadow-lg "></i>
          Rechazar
        </span>
      </div>
    </div>
    ...
    >
      <span class="pt-4 pb-2 text-xl text-white">
